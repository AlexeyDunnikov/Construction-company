$(function () {
  ...
  let findCurrentPageValue = function(){
    let currentSlickDot = document.querySelector('.equipment .slick-dots .slick-active');
    return currentSlickDot.textContent;
  }; 

  let findAllPagesValue = function(){
     let equipmentSlickDots = document.querySelectorAll(".equipment .slick-dots button");
